...
{
class PcdlessSubManager : public rclcpp::Node, BasePoseEstimatorSubManager
{
public:
  using Image = sensor_msgs::msg::Image;
  using NavPVT = ublox_msgs::msg::NavPVT;

  PcdlessSubManager() : Node("pcdless_sub_manager"), BasePoseEstimatorSubManager(this)
  {
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<multi_pose_estimator::PcdlessSubManager>());
  rclcpp::shutdown();
  return 0;
}
