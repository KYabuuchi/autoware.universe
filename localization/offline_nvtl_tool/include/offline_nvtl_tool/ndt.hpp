...
public:
  ...
  NdtInterface(rclcpp::Node * node) : ndt_ptr_(new NdtType)
  {
    ...
    std::cout << "ndt resolution: " << parameters.ndt.resolution << std::endl;
  ...
  std::pair<double, sensor_msgs::msg::PointCloud2> get_nvtl(
    ...
    const geometry_msgs::msg::Pose & pose_msg) const
  {
    ...
    sensor_msgs::msg::PointCloud2 cloud_in_map_frame_msg;
    pcl::toROSMsg(cloud_in_map_frame, cloud_in_map_frame_msg);

    return {nvtl, cloud_in_map_frame_msg};
  }
